import { CalculatePriceServiceAdapter } from '../../../src/application/services/calculate-price-service.adapter';
...
describe('# Test Unit Calculate Price Service Adapter', () => {
  ...
  const sut = new CalculatePriceServiceAdapter(loggerStub);
